  ...
  return (
    <header className="bg-slate-100 dark:bg-[#0D2743] font-[Open_Sans] shadow lg:h-16 px-4 flex sm:h-32 justify-between items-center">
      <div className="flex items-center justify-end">
        ...
        <h2 className="font-bold translate-x-[50%] lg:text-3xl font-[Unbuntu] sm:hidden lg:block sm:text-5xl bg-clip-text text-transparent bg-gradient-to-r from-indigo-500 to-blue-500 dark:text-white">
